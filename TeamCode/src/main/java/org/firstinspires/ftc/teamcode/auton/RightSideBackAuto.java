...
@Autonomous
public class RightSideBackAuto extends LinearOpMode {
    OpenCvCamera camera;
    ...
    private final double firstScorePosition = 0.215;
...
//        this.turretPid.update();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            targetTurretPosition = 0.21;
            targetPitchPosition = 0.81;
            while(this.drive.isBusy()) this.updateMotor();
            this.drive.addTargetR(Math.PI/2);
            this.drive.addTargetX(-2);
            while(this.drive.isBusy()) this.updateMotor();
//            this.drive.addTargetY(6);
//            while(this.drive.isBusy()) this.updateMotor();
...
//        frontArmPosition = 0;
    ...
    private void preIntakeMode(int i){
        ...
        this.targetArmPosition = C.getTargetFrontArmPosition(i);
        this.updatePosition();
        this.updateServo();
    }
