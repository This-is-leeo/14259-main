...
@Disabled
@Autonomous
public class RightSide1Plus5 extends LinearOpMode {
    private Drive drive;
    private int state = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            intakeBack();
            this.updateAll();
            this.targetTurretPosition = 0.05;
            this.targetPitchPosition = 0.05;
            sleep(200);
            this.turretRTP = true;
            this.pitchRTP = true;
            C.parked.set(false);
            AsyncThreaded.stopped = true;
            this.drive.addTargetY(-20);
...
//        frontArmPosition = 0;
    ...
    private void preIntakeMode(){
        this.targetFrontArmPosition = 0.3;
